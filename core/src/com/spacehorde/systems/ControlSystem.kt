...
class ControlSystem : EntitySystem() {
    ...
    override fun update(deltaTime: Float) {
        ...
        val playerSize = sizeMapper.get(player) ?: return
        ...
        if (controller != null) {
            ...
            handleFiring(mappedController, playerTransform, playerPhysics, playerSize)
    ...
    private fun handleFiring(mappedController: MappedController, playerTransform: Transform, playerPhysics: Physics, playerSize: Size) {
        ...
        if (axis.len() > 0) {
            ...
            val bullet = Entities.createBullet(v0.x, v0.y)
            ...
            physics.acceleration.set(v0.set(0f, 1f)
                    .rotate(transform.heading.angle())
                    .scl(physics.accelerationSpeed))
